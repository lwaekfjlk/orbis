...
| 围绕当前地点转向 | 点击右下角 **旋转箭头**，每次旋转四分之一圈；缩放、俯仰角和当前选中地点保持不变 |
...
逐步放大，就能看到同一片土地上密集的住宅、支巷、城墙、神殿、王宫与港口，主街、城门和地标入口保持畅通。近处地形会变得更细致，气候也会影响地表、植被和建筑外观。点击建筑可查看说明，**Details** 面板还可导出 GLB 格式的城镇三维模型，模型不含周围地形。
