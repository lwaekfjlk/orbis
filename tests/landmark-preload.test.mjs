...
test('two real workers prewarm every exact entry while parent buffers remain usable',async()=>{
 ...
 // Independently generated by the complete eager town path after the sovereignty
 // change; worker hydration must preserve those same current founding results.
 ...
 assert.equal(createHash('sha256').update(JSON.stringify(metadata(original))).digest('hex'),'21acd52dc3052aca20b261d8adbfc3beb613e5ceffe3fde15fbafd72d543ca23');
