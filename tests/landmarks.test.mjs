...
const scripts=['src/world/geography.js','src/civilization/realm-names.js', 'src/civilization/place-names.js', 'src/civilization/simulation.js','src/city/environment.js','src/civilization/high-citadels.js', 'src/towns/catalog.js','src/towns/grammar.js', 'src/towns/fortifications.js','src/city/high-citadel-plan.js','src/city/generator.js','src/city/actions.js','src/render/world-renderer.js','src/render/export-glb.js','src/landmarks/catalog.js','src/landmarks/kit.js','src/landmarks/dragon-ruins.js','src/landmarks/templates.js','src/landmarks/world-binding.js'];
