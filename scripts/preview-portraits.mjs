...
const html=`<!doctype html><html lang="zh-CN"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Telluric · 七族肖像</title><style>
...
</style><main><header><div class="eyebrow">TELLURIC / PEOPLE OF THE ATLAS</div><h1>七族，同一个世界。</h1><p>重绘脸部、五官与服饰，让每位讲述者都有自己的轮廓。</p></header><h2>肖像细节 · 132 PX</h2>${row(132,42)}<h2>城镇详情 · 104 PX</h2>${row(104,17)}<h2>地图卡片 · 72 PX</h2>${row(72,83)}<footer>七个种族 · 三位不同居民 · 与应用共用同一套肖像生成器</footer></main></html>`;
