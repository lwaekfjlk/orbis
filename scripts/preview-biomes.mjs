...
const html=`<!doctype html><html lang="zh-CN"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Telluric · 地貌细化对照</title>
...
<header><small>TELLURIC / LANDSCAPE STUDIES</small><h1>同一张地图，走近六种地貌。</h1><p>真实默认世界 Aereth-47。修复前后使用相同地理数据、镜头与光照，直接调用各自版本的地图地形构建器。</p></header>
