...
本页记录版本 2 的山形改进与旧气候对照。当前默认版本 3 继续修正板块、洋流、云水和灰色地表，见[最新说明与实图](TECTONICS_AND_LANDCOVER.md)。
...
本页山形对照使用 `landformVersion: 2`。当前默认版本为 3；已经公开的版本 0、1、2 均保留原算法，旧存档按自身版本恢复。重新生成世界即可使用最新规则。
