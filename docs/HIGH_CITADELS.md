...
| --- | --- | ---: | ---: | ---: |
| Blackley · Dragon King's Aerie | 239, 117 | 4,010 m | 761 | 14 |
| Coalwell · High Sanctuary | 242, 115 | 3,886 m | 759 | 14 |
...
Use map search for **dragon**, **holy**, **龙王城** or **圣城**. Directory entries visit the complete settlement, and building selection remains in the same map. A coiled dragon totem and sacred sun seal distinguish the two sites, using the same small monochrome styling as ordinary wonder marks.
