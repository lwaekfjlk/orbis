...
Dragon King Citadels, High Holy Cities and ancient dragon ruins have distinct local SVG symbols: a winged dragon crest, a radiant seal and a fractured dragon ring. Their map buttons preserve geographic anchors and receive space before map lettering; ordinary monument icons can yield to country names. Search presents the existing special sites and accepts their English names or 龙城, 圣城 and 龙族遗迹.
...
The streaming layer holds at most three sites, increases detail with zoom and releases old GPU resources when the world changes. Selecting a ruin moves the existing atlas camera; its parts list and GLB export refer to that site's mounted meshes.
