...
function initializeSettlements(w, options = {}) {
    ...
    const sim = { version: 6, year: 400, seed, physicalSeed: w.seed, physicalHash: physical, options: { realms: options.realms || 18, conflict: options.conflict ?? 1, historySeed, politySeed: String(options.politySeed ?? 'First-councils'), highCitadelsVersion: options.highCitadelsVersion ?? ([1, 2, 3].includes(w.params.landformVersion) ? 2 : 1) }, provinces: [], realms: [], relations: {}, wars: [], routes: [], events: [], history: [], nextWar: 1, totalBattles: 0, totalConquests: 0, totalSplits: 0 };
