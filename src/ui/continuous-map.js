...
window.ContinuousMap = (() => {
 ...
 function home(){if(!ready())return;OneMap.clearSelection();OneMap.closeDrawer();selection=null;layer.focusId=null;layer.select(null);return animate([0,0,0],1,1.19,1000);}
